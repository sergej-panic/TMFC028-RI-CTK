...
const {validateRequest, validateSpecHref, validateInventoryHref} = require('../utils/ruleUtils');
...
exports.createProductOrder = function(req, res, next) {
  ...
  swaggerUtils.getPayload(req)
    ...
    .then(payload => validateSpecHref(payload))
    .then(payload => validateInventoryHref(payload))
    .then(payload => {
...
exports.listProductOrder = function(req, res, next) {
  ...
  const resourceType = getResponseType(req);
//  console.log('Resource type: ', resourceType, query)
...
//      console.log('[MongoQuery] Final criteria and options:', {
